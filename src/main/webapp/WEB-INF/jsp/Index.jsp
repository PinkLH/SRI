        ...
        <nav>
            ...
            <div id="navBox" class="nav-box">
                ...
                <div id="LX-box" class="LX-box main_box">
                    <div class="LX main_info" onclick="downList(1)"><span class="title"><span class="iconfont icon-lixiangxiangmu"> </span>立项</span></div>
                ...
                <div id="HX-box" class="HX-box main_box">
                    <div class="HX main_info"  onclick="downList(2)"><span  class="title"><span class="iconfont icon-xiangmu1"> </span>横项</span><span class="iconfont icon-xiangyou1 icon_right"></span></div>
                    <div class="Main-list">
                        <ul>
                ...
                <div id="LW-box" class="LW-box main_box" > 
                    <div class="LW main_info" onclick="downList(3)"><span  class="title"><span class="iconfont icon-fabiaolunwen"> </span>论文</span><span class="iconfont icon-xiangyou1 icon_right"></span></div>
                    <div class="Main-list">
                        <ul>
                ...
                <div id="ZZ-box" class="ZZ-box main_box" >
                    <div class="ZZ main_info" onclick="downList(4)"><span  class="title"><span class="iconfont icon-zhaozhuanli"> </span>著作</span><span class="iconfont icon-xiangyou1 icon_right"></span></div>
                    <div class="Main-list">
                        <ul>
                ...
                <div id="ZL-box" class="ZL-box main_box" >
                    <div class="ZL main_info" onclick="downList(5)"><span  class="title"><span class="iconfont icon-xiangmu"> </span>专利</span><span class="iconfont icon-xiangyou1 icon_right"></span></div>
                    <div class="Main-list">
                        <ul>
                ...
                <div id="CG-box" class="CG-box main_box" >
                    <div class="CG main_info" onclick="downList(6)">&nbsp;&nbsp;<span style="width: 120px;" class="title"><span class="iconfont icon-keyanchengguohuojiang"> </span>成果获奖</span><span class="iconfont icon-xiangyou1 icon_right" style="margin-left: 30px;"></span></div>
                    <div class="Main-list">
                        <ul>
