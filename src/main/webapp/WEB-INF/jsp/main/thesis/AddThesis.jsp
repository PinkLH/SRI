...
<head>
    ...
    <title>论文添加</title>
    <script type="text/javascript" src="static/js/thesis/AddThesis.js"></script>
    <link rel="stylesheet" href="static/css/thesis/AddThesis.css">
    ...
    <form id="searchForm" class="layui-form" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="foot">
            ...
            <div class="layui-form-item1">
                <div class="layui-input-block">
                    <button type="button" onclick="confirmAdd('AddThesisInfo')" class="layui-btn" lay-submit
