...
<head>
    ...
    <title>成果添加</title>
    <script type="text/javascript" src="static/js/achievement/AddAchievement.js"></script>
    <link rel="stylesheet" href="static/css/achievement/AddAchievement.css">
    ...
    <form id="searchForm" class="layui-form" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="foot">
            <div class="layui-form-item1">
                <div class="layui-input-block">
                    <button type="button" onclick="confirmAdd('AddAchievementInfo')" class="layui-btn" lay-submit
