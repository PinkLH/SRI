...
<head>
    ...
    <script type="text/javascript" src="static/js/work/AddWork.js"></script>
    <style>
        .layui-input:focus,
...
<div class="all">
    <form id="searchForm" class="layui-form" action="" method="post" enctype="multipart/form-data">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" id='testselect'>
                <input type="radio" name="wtype" value="0" title="软件著作" checked>
                <input type="radio" name="wtype" value="1" title="学术著作">
            </div>
        </div>
        ...
        <!--ruanjian-->
        <div class="xueshu" id="xueshu"></div>
